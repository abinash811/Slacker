...
import { Folder, ShieldCheck, SlidersHorizontal, Tags, Timer, UsersRound } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Teams, roles, and the values people pick from when creating a ticket.</p>
      </div>
